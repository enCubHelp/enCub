...
public class ParsingErrLogTable
{
    ...
    public void Join(String parmProject)
    {
        ...
        try
        {
            ...
            String _sql = "SELECT DISTINCT a.project, a.plsql, b.err_line, b.err_column, b.content FROM parsingtbl a LEFT OUTER JOIN parsingerrlog b on a.project = b.project AND a.plsql = b.plsql WHERE a.project = '" + parmProject + "' ORDER BY a.project, a.plsql, b.err_line, b.err_column;";
...
//////                System.out.println("SEQ=[" + _seq + "]");
    ...
    public void Select(String parmProject, String parmPlsql)
    {
        ...
        try
        {
            ...
            {
                _sql = "SELECT DISTINCT PLSQL FROM ParsingErrLog WHERE Project = '" + parmProject + "' ORDER BY PLSQL;";
            }
            else
            {
                _sql = "SELECT * FROM ParsingErrLog WHERE Project = '" + parmProject + "' AND PLSQL = '" + parmPlsql + "' ORDER BY Project, PLSQL, SEQ;";
            }
            ResultSet _rs = _statement.executeQuery(_sql);
            while(_rs.next())
            {
    ...
    public void Insert(String parmProject, String parmPlsql, int parmSeq, int parmLine, int parmColumn, String parmContent)
    {
        ...
        try
        {
            _conn = _database.Connect();
            _statement = _conn.createStatement();
            String _sql = "INSERT INTO ParsingErrLog(Project, plsql, seq, err_line, err_column, content) Values('" +
    ...
    public void Delete(String parmProject, String parmPlsql)
    {
        ...
        try
        {
            _conn = _database.Connect();
            _statement = _conn.createStatement();
            String _sql = "DELETE ParsingErrLog WHERE Project = '" + parmProject + "' and Plsql = '" + parmPlsql + "';";
            _statement.executeUpdate(_sql);
            _conn.commit();
            _statement.close();
        }
    ...
    public static void main(String[] args) throws Exception
    {
                ...
                args[0].equals("JOIN"))
        {
            ...
            {
                if (_index > 0 &&
                    _selectList.get(_index)._project.equals(_selectList.get(_index - 1)._project) &&
                    _selectList.get(_index)._plsql.equals(_selectList.get(_index - 1)._plsql))
                {
                    continue;
                }
                System.out.println("Project=" + _selectList.get(_index)._project);
