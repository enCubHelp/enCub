...
public class Project
{
    public void Select(String parmProject)
    {
        ...
        try
        {
            ...
            while(_rs.next())
            {
                ...
                System.out.println("SourceDBMS=" + _rs.getString("SourceDBMS"));
                System.out.println("TargetDBMS=" + _rs.getString("TargetDBMS"));
    ...
    public void Insert(String parmProject, String parmSource, String parmTarget, String parmComment)
    {
        Database _database = new Database();
        Connection _conn = null;
        Statement _statement = null;
        try
        {
            ...
            String _sql = "INSERT INTO Project(Project, SourceDBMS, TargetDBMS, Comment) Values('" +
                          parmProject + "', '" + parmSource + "', '" + parmTarget + "', '" + parmComment +  "');";
